...
public class FrameHelp extends javax.swing.JFrame {
    ...
    public FrameHelp(int mode) {
        ...
        try {
            /*if (FrameHelp.SHOW_ABOUT == mode) this.editorPane.setPage(new File(Intelligence.configurator.getPathProperty("help_file_about")).toURL());
    ...
    private void initComponents() {
        ...
        editorPane.setBackground(new java.awt.Color(0, 153, 255));
        jScrollPane1.setViewportView(editorPane);

        helpWindowClose.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
